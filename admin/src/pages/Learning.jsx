              ...
              <div className="lm-header">
                ...
                <div className="lm-header-top">
                  ...
                  <div className="lm-actions">
                    ...
                    <button className="btn-lm-refresh"><FiRefreshCw size={14} /> Refresh</button>
                  </div>
                </div>
              </div>
              ...
              <div className="lm-course-grid">
                ...
                <div className="lm-card-footer">
                  <div className="lm-card-actions">
                    ...
                    <button className="lm-action-btn"><FiEdit2 size={12} /></button>
                    <button className="lm-action-btn"><FiBarChart2 size={12} /></button>
                    <button className="lm-action-btn"><FiUser size={12} /></button>
                  </div>
                      ...
                      <tr key={idx} style={{ borderBottom: '1px solid #F1F5F9' }}>
                        ...
                        <td style={{ padding: '16px 24px', textAlign: 'right' }}>
                          <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
                            ...
                            <button style={{ background: '#FEF2F2', border: '1px solid #FEE2E2', padding: '4px 12px', borderRadius: '6px', fontSize: '12px', color: '#EF4444', fontWeight: '500', cursor: 'pointer' }}>Delete</button>
                          </div>
                        </td>
                      </tr>
                    ))}
              ...
              {selectedEmployeeForAnalytics ? (
                selectedCourseForAnalytics ? (
                  ...
                  <div style={{ background: '#FFFFFF', borderRadius: '12px', border: '1px solid #E2E8F0', overflow: 'hidden' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 24px', borderBottom: '1px solid #F1F5F9' }}>
                      ...
                      <button style={{ display: 'flex', alignItems: 'center', gap: '8px', background: '#FFFFFF', border: '1px solid #E2E8F0', padding: '6px 12px', borderRadius: '6px', fontSize: '12px', color: '#1E293B', fontWeight: '600', cursor: 'pointer' }}>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    ...
                    <button style={{ display: 'flex', alignItems: 'center', gap: '8px', background: '#FFFFFF', border: '1px solid #E2E8F0', padding: '8px 16px', borderRadius: '8px', fontSize: '13px', color: '#1E293B', fontWeight: '600', cursor: 'pointer' }}>
                        ...
                        {courseAnalyticsEmployeesData.map((emp) => {
                          ...
                          return (
                            <tr key={emp.id} style={{ borderBottom: '1px solid #F1F5F9' }}>
                              ...
                              <td style={{ padding: '16px 24px', textAlign: 'center' }}>
                                <button style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', width: '28px', height: '28px', borderRadius: '6px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', color: '#64748B', cursor: 'pointer' }}>
                                  <FiEye size={14} />
                                </button>
                              </td>
                            </tr>
        ...
        <div className="lm-edit-quiz-view" style={{ paddingBottom: '80px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
            <div className="lm-tabs" style={{ background: '#FFFFFF', padding: '4px', borderRadius: '8px', border: '1px solid #E2E8F0', display: 'flex', gap: '4px' }}>
              <button className="lm-tab"><FiBookOpen className="lm-tab-icon" /> Courses</button>
              <button className="lm-tab active"><FiHelpCircle className="lm-tab-icon" /> Quizzes</button>
              <button className="lm-tab"><FiBarChart2 className="lm-tab-icon" /> Analytics</button>
            </div>
            <button 
            ...
            <div>
              ...
              <div className="lm-course-card">
                <div className="lm-card-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                  ...
                  <button style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', padding: '6px 12px', borderRadius: '6px', fontSize: '12px', color: '#475569', fontWeight: '600', cursor: 'pointer' }}>+ Add Question</button>
                </div>
                ...
                {[1, 2, 3].map((qNum) => (
                  <div key={qNum} className="lm-question-card" style={{ border: '1px solid #E2E8F0', borderRadius: '12px', padding: '20px', marginBottom: '20px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                      ...
                      <button style={{ background: '#F8FAFC', border: '1px solid #E2E8F0', padding: '4px 12px', borderRadius: '4px', fontSize: '11px', color: '#475569', fontWeight: '500', cursor: 'pointer' }}>Delete</button>
                    </div>
          ...
          <div className="lm-quiz-footer" style={{ position: 'fixed', bottom: 0, left: 240, right: 0, background: '#F8FAFC', borderTop: '1px solid #E2E8F0', padding: '16px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 10 }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              <button style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', padding: '8px 16px', borderRadius: '6px', fontSize: '13px', color: '#475569', fontWeight: '600', cursor: 'pointer' }}>Save as Draft</button>
              <button className="btn-create-course" style={{ padding: '8px 16px', fontSize: '13px' }}>Save Changes</button>
            </div>
          </div>
        </div>
      ) : isCreatingQuiz ? (
        <div className="lm-create-quiz-view" style={{ paddingBottom: '80px' }}>
          ...
          <div className="lm-course-card">
            <div className="lm-card-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                <button style={{ display: 'flex', alignItems: 'center', gap: '6px', background: '#FFFFFF', border: '1px solid #E2E8F0', padding: '6px 12px', borderRadius: '6px', fontSize: '12px', color: '#475569', fontWeight: '600', cursor: 'pointer' }}>
                  <LuFileText size={14} /> Bulk Upload (CSV)
                </button>
                <button className="btn-create-course" style={{ padding: '6px 12px', fontSize: '12px' }}>+ Add Question</button>
              </div>
            </div>
              ...
              <div key={qNum} className="lm-question-card" style={{ border: '1px solid #E2E8F0', borderRadius: '12px', padding: '20px', marginBottom: '20px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px' }}>
                    <button style={{ background: '#F8FAFC', border: 'none', padding: '4px 12px', borderRadius: '4px', fontSize: '11px', color: '#64748B', fontWeight: '600', cursor: 'pointer' }}>Copy</button>
                    <button style={{ background: '#FEF2F2', border: 'none', padding: '4px 12px', borderRadius: '4px', fontSize: '11px', color: '#EF4444', fontWeight: '600', cursor: 'pointer' }}>Delete</button>
                  </div>
                </div>
          ...
          <div className="lm-quiz-footer" style={{ position: 'fixed', bottom: 0, left: 240, right: 0, background: '#F8FAFC', borderTop: '1px solid #E2E8F0', padding: '16px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 10 }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              <button style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', padding: '8px 16px', borderRadius: '6px', fontSize: '13px', color: '#475569', fontWeight: '600', cursor: 'pointer' }}>Save Draft</button>
              <button className="btn-create-course" style={{ padding: '8px 16px', fontSize: '13px' }}>Publish Quiz</button>
            </div>
          </div>
        </div>
      ) : selectedCourseId ? (
        <div className="lm-course-details-view">
          <div className="lm-details-top-bar">
            <div className="lm-tabs">
              <button className="lm-tab active"><FiBookOpen className="lm-tab-icon" /> Courses</button>
              <button className="lm-tab"><FiHelpCircle className="lm-tab-icon" /> Quizzes</button>
              <button className="lm-tab"><FiBarChart2 className="lm-tab-icon" /> Analytics</button>
            </div>
          ...
          <div className="lm-details-header-section">
            ...
            <div className="lm-details-header-content">
              ...
              <div className="lm-details-actions">
                ...
                <button className="btn-form-next"><FiDownload size={14} /> Export Report</button>
              </div>
            </div>
          </div>
            ...
            <table className="lm-enrolled-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Today</td>
                  <td><button className="btn-remind">Remind</button></td>
                </tr>
                <tr>
                  <td>
                    <div className="lm-employee-cell">
                    ...
                    <div className="lm-employee-search-dropdown">
                      {employees.slice(0, 5).map(emp => (
                        <div key={emp.id} className="lm-employee-item">
                          ...
                          <button className="btn-add-employee">+ Add</button>
                        </div>
                      ))}
                    </div>
