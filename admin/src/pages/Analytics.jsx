        ...
        <>
          <div className="analytics-card">
            <div className="ac-header">
              ...
              <button onClick={() => console.log("Button clicked!")} className="ac-btn-refresh"><FiRefreshCw size={14} /> Refresh</button>
            </div>
        ...
        <div className="attendance-view">
          ...
          <div className="attendance-filters">
            <div className="filter-group">
              <button onClick={() => console.log("Button clicked!")} className="filter-btn">Last 7 Days</button>
              <button onClick={() => console.log("Button clicked!")} className="filter-btn">Last 30 Days</button>
              <button onClick={() => console.log("Button clicked!")} className="filter-btn">This Month</button>
              <button onClick={() => console.log("Button clicked!")} className="filter-btn active">Last Month</button>
            </div>
            ...
            <button onClick={() => console.log("Button clicked!")} className="btn-load-analytics"><FiClock size={14} /> Load Analytics</button>
          </div>
      ...
      {activeTab === 'Productivity' && (
        <div className="attendance-view">
          ...
          <div className="attendance-filters">
            ...
            <button onClick={() => console.log("Button clicked!")} className="btn-load-analytics"><FiClock size={14} /> Load Productivity</button>
          </div>
