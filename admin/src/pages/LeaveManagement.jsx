      ...
      {activeTab === 'Leave Balances' && (
        <div className="balances-content">
          <div className="balances-filters">
            ...
            <button className="filter-btn-outline">FY 2025-26</button>
          </div>
            ...
            <div className="calendar-left-pane">
              <div className="calendar-header">
                <div className="calendar-nav">
                  <button className="calendar-nav-btn"><FiChevronLeft /></button>
                  <h2>April 2026</h2>
                  <button className="calendar-nav-btn"><FiChevronRight /></button>
                </div>
