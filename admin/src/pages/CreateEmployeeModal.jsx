            ...
            <>
              <div className="cem-field">
                ...
                <div className="cem-role-group">
                  <button onClick={() => console.log("Button clicked!")} className="cem-role-btn">Admin</button>
                  <button onClick={() => console.log("Button clicked!")} className="cem-role-btn active">Employee</button>
                  <button onClick={() => console.log("Button clicked!")} className="cem-role-btn">HR manager</button>
                  <button onClick={() => console.log("Button clicked!")} className="cem-role-btn">Manager</button>
                </div>
              </div>
