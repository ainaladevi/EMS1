    ...
    <div className="hr-overview-page">
      ...
      <div className="hr-table-container">
        <div className="hr-toolbar">
          ...
          <button onClick={() => console.log("Button clicked!")} className="btn-reset">Reset</button>
        </div>
        ...
        <div className="hr-sub-toolbar" style={{ justifyContent: selectedEmps.length > 0 ? 'space-between' : 'flex-end' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            {selectedEmps.length > 0 && (
              <>
                <button onClick={() => console.log("Button clicked!")} className="btn-edit-sub">Edit</button>
            ...
            <button onClick={() => console.log("Button clicked!")} className="btn-bulk-onboard">Bulk onboard</button>
          </div>
        </div>
              ...
              <tr key={emp.id} className={selectedEmps.includes(emp.id) ? 'hr-row-selected' : ''}>
                ...
                <td>
                  <div className="action-btns">
                    ...
                    <button onClick={() => console.log("Button clicked!")} className="btn-action-outline">Onboard</button>
                  </div>
                </td>
              </tr>
            ))}
        ...
        <div className="hr-pagination">
          ...
          <div className="pagination-controls">
            <button onClick={() => console.log("Button clicked!")} className="page-btn"><FiChevronLeft /></button>
            ...
            <button onClick={() => console.log("Button clicked!")} className="page-btn"><FiChevronRight /></button>
          </div>
        </div>
      </div>
